...
public class EmailService
{
	...
	public void reservationExpiredNotification() throws MessagingException
	{
		...
		{
			String html = "<h1>Please return your reserved item!</h1><br>" + "The item: "
					+ res.getItem().getLabItem().getItemName() + "must be returned as soon as possible."
					+ "<br>Reservation due date: " + res.getReturnableDate() + "<br><br>Kind regards, <br>Group 4";

			String html_admin = "<h1>A users reservation expired!</h1><br>" + "The item: "
					+ res.getItem().getLabItem().getItemName() + "from user" + res.getUser().getUsername() + "with:"
					+ "<br>Reservation due date: " + res.getReturnableDate() + "expired"
	...
	public void reservationExpiresSoonNotification() throws MessagingException
	{
		...
		for (Reservation res : reservations)
		{
			String html = "<h1>Please return your reserved items on time!</h1><br>" + "The item: "
					+ res.getItem().getLabItem().getItemName() + "must be returned until reservation due date: "
					+ res.getReturnableDate() + "<br><br>Kind regards, <br>Group 4";
	...
	public void sendPassword(String pass, String email) throws MessagingException
	{
		String html = "Your password is " + pass;
		String title = "Access Data";
		sendNotificationEmail(email, title, html);
	}
}